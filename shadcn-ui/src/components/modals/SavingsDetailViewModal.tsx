...
export function SavingsDetailViewModal({ account, isOpen, onClose }: SavingsDetailViewModalProps) {
  ...
  const getAccountTypeBadge = (type: string) => {
    switch (type) {
      case 'pokok':
        return <Badge className="bg-blue-100 text-blue-800">Simpanan Pokok</Badge>;
      case 'wajib':
        return <Badge className="bg-green-100 text-green-800">Simpanan Wajib</Badge>;
      case 'sukarela':
        return <Badge className="bg-purple-100 text-purple-800">Simpanan Sukarela</Badge>;
      case 'hariRaya':
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <DialogTitle className="text-xl font-bold">Detail Rekening Simpanan</DialogTitle>
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 mt-1">Akumulasi setoran</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Dibuka: {new Date(account.openDate).toLocaleDateString('id-ID')}
                </p>
              </CardContent>
            </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-medium">{getAccountTypeName(account.type)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Tanggal Pembukaan</p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-medium">{formatCurrency(account.monthlyDeposit)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Tingkat Bunga</p>
                    <p className="font-medium">{account.interestRate}% per tahun</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Total Penarikan</p>
                    <p className="font-medium">{formatCurrency(account.totalWithdrawals)}</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardHeader>
              <CardTitle className="text-blue-900">Keuntungan Simpanan Ini</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h4 className="font-medium text-blue-900 mb-2">Manfaat:</h4>
                  <ul className="space-y-1 text-blue-700">
                    <li>• Bunga kompetitif {account.interestRate}% per tahun</li>
                ...
                <div>
                  <h4 className="font-medium text-blue-900 mb-2">Fasilitas:</h4>
                  <ul className="space-y-1 text-blue-700">
