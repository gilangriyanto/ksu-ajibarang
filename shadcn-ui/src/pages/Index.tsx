...
export default function WelcomePage() {
  ...
  const totalLoanAmount = activeLoans.reduce((sum, loan) => sum + loan.remaining_balance, 0);
  
  const currentMonth = new Date().toISOString().slice(0, 7);
  const currentMonthServiceFees = serviceFees.filter(sf => sf.period === currentMonth);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Koperasi Simpan Pinjam</h1>
                <p className="text-sm text-gray-600">Sistem Manajemen Koperasi</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Kelola anggota, simpanan, pinjaman, dan jasa pelayanan dengan mudah dan efisien
          </p>
