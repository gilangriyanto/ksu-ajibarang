...
export default function CashAccountsPage() {
  ...
  const deletingAccount = cashAccounts.find(
      ...
      <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={typeFilter} onValueChange={setTypeFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="II">
                      Kas Pembiayaan Barang dan Logistik
                    </SelectItem>
                    <SelectItem value="III">Kas Sebrakan</SelectItem>
                    <SelectItem value="IV">Kas Kantin</SelectItem>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Total {filteredAccounts.length} kas
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                ...
                <TableBody>
                  {filteredAccounts.map((account) => (
                    <TableRow key={account.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant={cashAccountsService.getTypeBadgeColor(
                            account.type,
                          )}
                        >
                      ...
                      <TableCell className="text-right font-semibold text-green-600">
                        {cashAccountsService.formatCurrency(
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle>
                {editingAccount ? "Edit Kas" : "Tambah Kas Baru"}
              </DialogTitle>
              <DialogDescription>
                {editingAccount
                  ? "Perbarui informasi kas"
                  : "Masukkan informasi kas baru"}
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="code">
                  Kode Kas <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="code"
                  value={formData.code}
              ...
              <div className="grid gap-2">
                <Label htmlFor="type">
                  Tipe Kas <span className="text-red-500">*</span>
                </Label>
                <Select
                  value={formData.type}
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="II">II - Kas Logistik</SelectItem>
                    <SelectItem value="III">III - Kas Sebrakan</SelectItem>
                    <SelectItem value="IV">IV - Kas Kantin</SelectItem>
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Anda yakin ingin menghapus kas{" "}
                <strong>{deletingAccount?.name}</strong> (
                {deletingAccount?.code})? Tindakan ini tidak dapat dibatalkan.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
