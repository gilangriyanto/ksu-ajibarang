...
export function SavingsDetailModal({
  ...
  console.log("Modal render - isOpen:", isOpen, "savings:", savings);
  ...
  // Mock transaction history - only if savings exists
  const mockTransactions = savings
    ? [
        {
          date: "2024-01-28",
          type: "deposit",
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <DialogDescription className="flex items-center space-x-2">
                      <span>
                        {savings.memberNumber} - {savings.memberName}
                      </span>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {new Date(savings.lastTransaction).toLocaleDateString(
                          "id-ID"
                        )}
                      </p>
                    </div>
